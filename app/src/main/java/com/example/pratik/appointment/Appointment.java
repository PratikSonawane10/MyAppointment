...
import com.example.pratik.appointment.model.Appointment_items;
import com.example.pratik.appointment.sessionManager.SessionManager;
import com.example.pratik.appointment.sliderActivity.PrefManager;
import com.example.pratik.appointment.sqlLite.DataBaseHelper;
import com.example.pratik.appointment.webService.WebService;
...
//                            gridcell.setBackgroundColor(getResources().getColor(R.color.fabBtnColor));
//                        }
//                        //for absent
...
//                                    gridcell.setBackgroundColor(getResources().getColor(R.color.colorwhite));
//                                } else {
//                                    gridcell.setBackgroundColor(getResources().getColor(R.color.colorred500));
//                                }
...
//                            }
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == R.id.calendar_day_gridcell) {
                ...
                //Appointment_items listData = new Appointment_items();
                ...
                for (int i = 0; i < itemsDetails.size(); i++) {
                    ...
                    if (listItems.getPresentDate().equals(day)) {
                        ...
                        String  Appointmentid = listItems.getAppointmentid();
                        String  Full_Name =  listItems.getFull_Name();
                        String  Phone_no =  listItems.getPhone_no();
                        String  Appointment_dates = listItems.getAppointment_dates();
                        String  Appointment_time = listItems.getAppointment_time();
                        String  CountryName = listItems.getCountryName();
                        String  city = listItems.getcity();
                        String  Hotel_name =  listItems.getHotelName();
                        String  HotelMobileNo = listItems.getHotelMobileNo();
                        String  Appointment_Type = listItems.getAppointment_Type();
                        String  AppointmentDate = listItems.getPresentDate();

                        Intent gotoDetails = new Intent(view.getContext(),Appointment_Details.class);
                        gotoDetails.putExtra("Appointmentid", Appointmentid);
                        gotoDetails.putExtra("Full_Name", Full_Name);
                        gotoDetails.putExtra("Phone_no", Phone_no);
                        gotoDetails.putExtra("Appointment_dates", Appointment_dates);
                        gotoDetails.putExtra("Appointment_time", Appointment_time);
                        gotoDetails.putExtra("CountryName", CountryName);
                        gotoDetails.putExtra("city", city);
                        gotoDetails.putExtra("Hotel_name", Hotel_name);
                        gotoDetails.putExtra("HotelMobileNo", HotelMobileNo);
                        gotoDetails.putExtra("Appointment_Type", Appointment_Type);
                        gotoDetails.putExtra("AppointmentDate", AppointmentDate);
