...
import com.example.pratik.appointment.adapter.AdapterForSpinner;
import com.example.pratik.appointment.connectivity.GetDepartMent;
import com.example.pratik.appointment.internetConnectivity.NetworkChangeReceiver;
...
public class Login extends Activity implements View.OnClickListener {
    ...
    private void getListOfStandard() {
        spinnerDialogBox = ProgressDialog.show(this, "", "Fetching Standard Please Wait...", true);
