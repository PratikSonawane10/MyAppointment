package com.example.pratik.appointment.adapter;
...
import com.example.pratik.appointment.Appointment;
import com.example.pratik.appointment.MainActivity;
import com.example.pratik.appointment.model.DrawerItems;
import com.example.pratik.appointment.R;
import com.example.pratik.appointment.sessionManager.SessionManager;

import com.example.pratik.appointment.singleton.DrawerListInstance;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (this.getAdapterPosition() == 0) {
                ...
                drawer.closeDrawers();
                Intent gotoformhome = new Intent(view.getContext(), Appointment.class);
                view.getContext().startActivity(gotoformhome);
